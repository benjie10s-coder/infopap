...
export function InvoiceEditor() {
  ...
  useEffect(() => {
    ...
    if (store.currentInvoiceId !== null || store.from.name.trim() !== "") return;
  ...
  }, [authLoading, profileLoading, user, preference, profile, store.currentInvoiceId, store.from.name, applyPrefill]);
