// components/PdfPreview.tsx — PDF preview via native browser PDF viewer
// Uses BlobProvider to generate a blob URL, then renders in an iframe.
// Works on all modern browsers (desktop + mobile) without pdf.js or canvas.
"use client";
      ...
      <BlobProvider document={deferredDoc}>
        {({ url, loading, error }) => (
          <>
            ...
            {/* ── PDF in iframe — works on all modern browsers ── */}
            {url && (
              <div
