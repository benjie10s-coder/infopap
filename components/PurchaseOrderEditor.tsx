  ...
  const savePurchaseOrder = useCallback(async (): Promise<string | null> => {
    ...
    try {
      ...
      const payload = {
        ...
        shipToName: emptyToUndef(store.shipTo.name),
        shipToCompanyName: emptyToUndef(store.shipTo.companyName),
        shipToAddress: emptyToUndef(store.shipTo.address),
        shipToCity: emptyToUndef(store.shipTo.city),
        shipToZipCode: emptyToUndef(store.shipTo.zipCode),
        shipToPhone: emptyToUndef(store.shipTo.phone),
