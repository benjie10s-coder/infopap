      ...
      <div className="mx-auto flex items-center justify-between px-6 py-4 gap-4">
        ...
        <div className="flex items-center shrink-0 gap-4">
          <a
            ...
            className="flex items-center gap-2 text-[#25D366] hover:text-[#1ebe5d] transition-colors text-sm font-medium"
        ...
        <div className="flex items-center gap-3 shrink-0">
          <a
            href="https://linkedin.com/in/benjamin-njami-0318501b2"
            target="_blank"
            rel="noopener noreferrer"
            className="text-ink/30 hover:text-[#0A66C2] transition-colors"
            title="LinkedIn"
            aria-label="LinkedIn"
          >
            <LinkedInIcon />
          ...
          <a
            href="https://facebook.com/romanbenjie/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-ink/30 hover:text-[#1877F2] transition-colors"
            title="Facebook"
            aria-label="Facebook"
          >
            <FacebookIcon />
          </a>
          <span className="text-[11px] text-ink/30 ml-1">&copy; {year}</span>
        </div>
      </div>
    </footer>
  );
